...
<form method="post" action="<?php echo get_site_url() . '/wp-admin/admin-post.php'; ?>">
  ...
  <div class="ets-discord-input-group">
	...
	<input type="text" class="ets-input" name="ets_ultimatemember_discord_client_id" value="
	<?php
	...
	<div class="ets-discord-input-group">
	  <label><?php esc_html_e( 'Client Secret', 'ultimate-member-discord-add-on' ); ?> :</label>
		<input type="text" class="ets-input" name="ets_ultimatemember_discord_client_secret" value="
		<?php
	...
	<div class="ets-discord-input-group">
	  ...
	  <label><?php esc_html_e( 'Bot Token', 'ultimate-member-discord-add-on' ); ?> :</label>
		  <input type="password" class="ets-input" name="ets_ultimatemember_discord_bot_token" value="
		  <?php
